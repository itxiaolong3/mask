...
$sql="select a.*,b.ID as id,b.Name as onename from " . tablename("mask_typetwomy") . " a"
    . " left join " . tablename("mask_typeonemy")
    . " b on a.Pid=b.id " .$where." order by a.ID asc";
$list=pdo_fetchall($sql,$data);
if($_GPC['op']=='delete'){
	$res=pdo_delete('mask_typetwomy',array('ID'=>$_GPC['id']));
	if($res){
